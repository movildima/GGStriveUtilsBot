...
namespace GGStriveUtilsBot.SlashCommands
{
    class FrameDataSlashModule : ApplicationCommandModule
    {
        ...
        public async Task FrameDataCommand(InteractionContext ctx, /*[Option("Character", "Character in question")] Character character, */[Option("Request", "(Optional) Character name, followed by move name or numpad notation of it")] string move)
        {
