...
namespace GGStriveUtilsBot.SlashCommands
{
    class FrameDataSlashModule : SlashCommandModule
    {
        ...
        public async Task FrameDataCommand(InteractionContext ctx, [Option("Character", "Sol Badguy")] Character character, [Option("Move", "Move name or numpad notation of it")] string move)
        {
